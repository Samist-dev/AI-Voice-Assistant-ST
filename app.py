...
# Load the keys from your hidden .env file into the system environment
load_dotenv()

# Fetch the token securely using os.environ
hf_token = os.environ.get("HUGGINGFACEHUB_API_TOKEN")

# Pass the securely fetched token to the client
